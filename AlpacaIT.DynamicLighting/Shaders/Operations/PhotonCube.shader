Shader "Hidden/Dynamic Lighting/PhotonCube"
{
    ...
    SubShader
    {
        ...
        // dynamic lighting render pipeline - transparent:
        Pass
        {
            CGPROGRAM
            #include_with_pragmas "Packages/de.alpacait.dynamiclighting/AlpacaIT.DynamicLighting/Shaders/Generators/PhotonCubeTransparent.cginc"
            ENDCG
        }
    }
    ...
    SubShader
    {
        ...
        // built-in render pipeline - transparent:
        Pass
        {
            CGPROGRAM
            #include_with_pragmas "Packages/de.alpacait.dynamiclighting/AlpacaIT.DynamicLighting/Shaders/Generators/PhotonCubeTransparent.cginc"
    ...
    SubShader
    {
        ...
        // built-in render pipeline - transparent cutout:
        Pass
        {
            CGPROGRAM
            #include_with_pragmas "Packages/de.alpacait.dynamiclighting/AlpacaIT.DynamicLighting/Shaders/Generators/PhotonCubeTransparent.cginc"
