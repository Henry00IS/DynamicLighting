...
{
    /// <summary>
    /// Represents a bounding volume node containing either more bounding volumes or objects
    ...
    internal struct BvhNode
    {
        ...
        /// <summary>When <see cref="isLeaf"/> contains the left node index else the first object index.</summary>
        ...
        /// <summary>The amount of objects contained within this bounding volume.</summary>
        public int count;

        // -- 16 byte boundary --

        /// <summary>Gets whether this node is a leaf containing object indices.</summary>
